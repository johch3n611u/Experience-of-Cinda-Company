...
public class AccountShift : Profile
    {
        public AccountShift()
        {
            CreateMap<ACCOUNT, Account>()
                        ...
                        .ForMember(s => s.LastRefSignFormId, opt => opt.MapFrom(s => s.LAST_REF_SIGN_FORM_ID))
                        ...
                        .ForMember(s => s.DomainName, opt => opt.MapFrom(s => s.DOMAIN_NAME))
                        .ForMember(s => s.Attachment, opt => opt.MapFrom(s => s.ATTACHMENT))
                        ...
                        .ForMember(s => s.EnablePrint, opt => opt.MapFrom(s => s.ENABLE_PRINT))
                        .ForMember(s => s.EnableFax, opt => opt.MapFrom(s => s.ENABLE_FAX))
                        ...
                        .ForMember(s => s.EnableView, opt => opt.MapFrom(s => s.ENABLE_VIEW))
                        .ForMember(s => s.EnableDowload, opt => opt.MapFrom(s => s.ENABLE_DOWNLOAD))
                        .ForMember(s => s.EnableCopy, opt => opt.MapFrom(s => s.ENABLE_COPY))
                        .ForMember(s => s.EnableUpload, opt => opt.MapFrom(s => s.ENABLE_UPLOAD))
                        ...
                        .ForMember(s => s.Group, opt => opt.MapFrom(s => s.GROUP))
                        ...
                        .ForMember(s => s.StartDate, opt => opt.MapFrom(s => s.START_DATE))
                        .ForMember(s => s.EndDate, opt => opt.MapFrom(s => s.END_DATE))
                        ...
                        .ForMember(s => s.LeavingControls, opt => opt.MapFrom(s => s.LEAVING_CONTROLS))
                        .ForMember(s => s.FtpPermission, opt => opt.MapFrom(s => s.FTP_PERMISSION))
                        .ForMember(s => s.FolderName, opt => opt.MapFrom(s => s.FOLDER))
                        .ForMember(s => s.DetpCenter, opt => opt.MapFrom(s => s.DEPT_CENTER))
                        .ForMember(s => s.EnableUsedepartment, opt => opt.MapFrom(s => s.ENABLE_USEDEPARTMENT))
            ...
            CreateMap<Account, ACCOUNT>()
                ...
                .ForMember(s => s.LAST_REF_SIGN_FORM_ID, opt => opt.MapFrom(s => s.LastRefSignFormId))
                ...
                .ForMember(s => s.DOMAIN_NAME, opt => opt.MapFrom(s => s.DomainName))
                .ForMember(s => s.ATTACHMENT, opt => opt.MapFrom(s => s.Attachment))
                ...
                .ForMember(s => s.START_DATE, opt => opt.MapFrom(s => s.StartDate))
                .ForMember(s => s.END_DATE, opt => opt.MapFrom(s => s.EndDate))
                ...
                .ForMember(s => s.LEAVING_CONTROLS, opt => opt.MapFrom(s => s.LeavingControls))
                .ForMember(s => s.FTP_PERMISSION, opt => opt.MapFrom(s => s.FtpPermission))
                .ForMember(s => s.FOLDER, opt => opt.MapFrom(s => s.FolderName))
                .ForMember(s => s.DEPT_CENTER, opt => opt.MapFrom(s => s.DetpCenter))
                .ForMember(s => s.ENABLE_USEDEPARTMENT, opt => opt.MapFrom(s => s.EnableUsedepartment))
                .ForMember(s => s.ISCROSS, opt => opt.MapFrom(s => s.IsCross))
                ;
        }
    }
